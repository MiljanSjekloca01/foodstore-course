...
router.post("/create", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                food = req.body;
                newFood = new food_model_1.FoodModel(food);
                return [4 /*yield*/, newFood.save()];
            case 1:
                _a.sent();
                res.status(http_status_1.HTTP_OK).send(newFood);
                return [2 /*return*/];
        }
    });
}); }));
// Updejtovanje postojece hrane Postman
router.put("/update/:foodId", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var newFoodData, updatedFoodData;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                newFoodData = req.body;
                return [4 /*yield*/, food_model_1.FoodModel.findByIdAndUpdate(req.params.foodId, newFoodData)];
            case 1:
                updatedFoodData = _a.sent();
                if (!updatedFoodData || updatedFoodData === null) {
                    return [2 /*return*/, res.status(http_status_1.HTTP_NOT_FOUND).send("Food not found")];
                }
                res.status(http_status_1.HTTP_OK).send(updatedFoodData);
                return [2 /*return*/];
        }
    });
}); }));
// Brisanje postojece hrane Postman
router.delete("/delete/:foodId", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, food_model_1.FoodModel.findById(req.params.foodId)];
            case 1:
                if (!(_a.sent())) {
                    return [2 /*return*/, res.status(http_status_1.HTTP_NOT_FOUND).send("User with this id not found")];
                }
                return [4 /*yield*/, food_model_1.FoodModel.findByIdAndDelete(req.params.foodId)];
            case 2:
                _a.sent();
                res.status(http_status_1.HTTP_OK).send("Food deleted");
                return [2 /*return*/];
        }
    });
}); }));
